...
export class ArticlesComponent implements OnInit {
  ...
  constructor(private tagService: TagsService, private articleService: ArticleService, private route: ActivatedRoute) {
  ...
  getFeed(feedSource: string, event: { page: number, itemsPerPage: number } = { page: 1, itemsPerPage: 10 }) {
    const limit = 10
